<template>
    <div class="min-h-screen bg-gray-100 dark:bg-black px-6 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        >
          ...
          <p class="text-gray-600 dark:text-gray-300 text-sm">Clics: {{ campana.clics }} / Impresiones: {{ campana.impresiones }}</p>
  ...
  onMounted(async () => {
    ...
    try {
      const res = await axios.get('http://localhost:3000/api/dashboard/publicista', {
