  ...
  <div class="min-h-screen bg-slate-950 text-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="text-sm">
          <ol class="flex items-center space-x-2 text-slate-300 flex-wrap">
            ...
            <li>/</li>
            <li><span class="text-orange-500">{{ params.año }} {{ params.modelo }} {{ params.combustible }}</span></li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <h1 class="text-4xl font-bold mb-4">
            {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} {{ combustibleCapitalizado }} {{ estadoCapitalizado }} en {{ comunaCapitalizada }}
          </h1>
          <p class="text-xl text-slate-300 max-w-4xl mx-auto">
            {{ vehiculosEncontrados }} {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} {{ estadoCapitalizado.toLowerCase() }}s con motor {{ combustibleCapitalizado }} 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg p-4 text-center" v-if="vehiculosEncontrados > 0">
          <div class="text-2xl font-bold text-orange-600">{{ params.año }}</div>
      ...
      <div v-else-if="vehiculos.length === 0" class="text-center py-12">
        <div class="mb-8">
          <h2 class="text-2xl font-bold mb-4">
            No hay {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} {{ estadoCapitalizado.toLowerCase() }}s disponibles en {{ comunaCapitalizada }}
          </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p class="text-slate-700 mb-4">
              {{ comunaCapitalizada }} es una ubicación estratégica para encontrar {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} {{ estadoCapitalizado.toLowerCase() }}s. 
          ...
          <div>
            <h2 class="text-2xl font-bold mb-4">
              {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} {{ combustibleCapitalizado }}
            </h2>
            <p class="text-slate-700 mb-4">
              El {{ marcaCapitalizada }} {{ modeloCapitalizado }} {{ params.año }} con motor {{ combustibleCapitalizado }} 
...
const configurarSEO = () => {
  const title = `${marcaCapitalizada.value} ${modeloCapitalizado.value} ${params.año} ${combustibleCapitalizado.value} ${estadoCapitalizado.value} en ${comunaCapitalizada.value} - Autoventas360`
  
  const description = vehiculosEncontrados.value > 0 
    ? `${vehiculosEncontrados.value} ${marcaCapitalizada.value} ${modeloCapitalizado.value} ${params.año} ${estadoCapitalizado.value.toLowerCase()}s con motor ${combustibleCapitalizado.value} en ${comunaCapitalizada.value}, ${regionCapitalizada.value}. Precios desde $${precioMinimo.value.toLocaleString()}. ¡Encuentra tu auto ideal!`
    : `Busca ${marcaCapitalizada.value} ${modeloCapitalizado.value} ${params.año} ${estadoCapitalizado.value.toLowerCase()}s con motor ${combustibleCapitalizado.value} en ${comunaCapitalizada.value}. Explora alternativas y encuentra el vehículo perfecto para ti.`
  
  const keywords = [
    `${params.marca} ${params.modelo} ${params.año} ${params.estado}`,
  ...
  useHead({
    ...
    meta: [
      ...
      { name: 'vehicle.year', content: params.año },
      { name: 'vehicle.fuel_type', content: params.combustible }
    ],
    link: [
      { 
        rel: 'canonical', 
        href: `https://autoventas360.com/${params.region}/${params.comuna}/${params.estado}/${params.marca}/${params.año}/${params.modelo}/${params.combustible}` 
      }
    ]
  })
  ...
  const structuredData = {
    ...
    "url": `https://autoventas360.com/${params.region}/${params.comuna}/${params.estado}/${params.marca}/${params.año}/${params.modelo}/${params.combustible}`,
    "address": {
      "@type": "PostalAddress",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": `${marcaCapitalizada.value} ${modeloCapitalizado.value} ${params.año} ${estadoCapitalizado.value}`,
